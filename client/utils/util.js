...
function formatDateYYYYmmdd(originDate, seperator) {
  ...
  newDate.setTime(originDate);
  var tSeperator = '-'
  var newDateStr = newDate.toLocaleString()
  var year = newDateStr.substr(0, 4)
  var month = newDateStr.substr(5, 2)
  var day = newDateStr.substr(8, 2)
  var result = year + tSeperator + month + tSeperator + day
  // var result = ''
